...
export const HeroSection = () => {
  return (
    <div className="flex flex-col justify-normal items-center w-1/2 h-full mt-36 mb-48">
      <h1 className="text-6xl font-bold text-center">
        Finding the perfect match for innovations.
      </h1>
      <p className="text-lg opacity-60 m-8 text-center">
      ...
      <div className="flex gap-4">
        <input
          className="bg-gray w-72 rounded-3xl px-3 py-2 text-sm "
